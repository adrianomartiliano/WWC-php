...
<body class="bg-1">
    <div class="card border-secondary mb-3">
        <div class="card-header flex-between">Seja um apoiador
        </div>
        
        <div class="card-body">
            <h5 class="card-title">Incentive, doe, valorize!</h5>
            <p class="card-text">Seja um dos apoiadores e incentivadores dessa iniciativa. Faça uma doação de qualquer valor e tenha seu nome registrado como forma de gratidão! 
